...
export default async function Home() {
  ...
  return (
    <AppLayout>
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6">
          <h1 className="font-cormorant font-light text-white text-4xl sm:text-5xl md:text-6xl lg:text-8xl text-center leading-none tracking-tight mb-8">
            New Collection<br/>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            ...
            <Link 
              href="/lookbook" 
              className="hidden sm:block px-10 py-4 border border-white text-white font-mono text-[11px] uppercase tracking-[0.2em] hover:bg-white hover:text-black transition-colors duration-300 text-center"
            >
              View Lookbook
            </Link>
          </div>
    ...
    <h2 className="font-mono text-[11px] uppercase tracking-[0.2em] text-muted-foreground">Our Luxuries</h2>
  </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12">
          {[
            { name: "Clothes", img: "https://res.cloudinary.com/ddpyuv5zp/image/upload/q_auto/f_auto/v1775923864/343c307b-4097-4958-9c0d-cb5ec774b003.png", link: "/shop?category=clothes" },
            { name: "Handbags", img: "https://res.cloudinary.com/ddpyuv5zp/image/upload/q_auto/f_auto/v1774110669/Elegant_Women_Handbag_for_Everyday_Style_Luxury_Look_tqzpdv.jpg", link: "/shop?category=handbags" },
            { name: "Accessories", img: "https://res.cloudinary.com/ddpyuv5zp/image/upload/q_auto/f_auto/v1775923990/307b0fb6-6510-4098-bc5f-b0c634ddf304.png", link: "/shop?category=accessories" },
          ].map((cat) => (
