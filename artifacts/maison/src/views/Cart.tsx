        ...
        {!items?.length ? (
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="w-full lg:w-[350px] bg-secondary p-8 h-max">
              ...
              <Link href="/checkout" className="block text-center w-full bg-foreground text-background py-5 font-mono text-[11px] uppercase tracking-[0.2em] hover:bg-primary transition-all">
                Proceed to Checkout
              </Link>
            </div>
          </div>
